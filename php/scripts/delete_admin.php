<!-- Script permettant de retirer les droits administrateurs à un compte utilisateur -->
...
<?php
   ...
   // Reqête permettant d'éffectuer la modification et de retirer les droits admin
   ...
   header('Location: ../pages/settings_admin.php?delete=1&check_delete_admin=' . $email_user);
?>