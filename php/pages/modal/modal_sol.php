<div class="modal fade" id="editSol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
   <div class="modal-dialog" role="document" id="modal-lieux">
      <div class="modal-content" id="modal-lieux-width">
      <div class="modal-header" style="margin-bottom: 10px;">
         <h3 class="modal-title" id="exampleModalLongTitle">Gestion du sol</h3>
      ...
      <?php     
         ...
         $reponse = $bdd->query("SELECT *
                                 ...
                                 AND fondation.id_type_equipement = 3
         ...
         <ul>
            ...
            foreach($fondation as $fondation) {
               ...
               <li class="modal-list">
                  ...
                  $url = '../scripts/edit_fondation.php?id=' . 
                        $_GET['id'] . '&link=' . $_GET['link'] . '&id_fondation=' . $fondation['id_fondation'] . '&id_type_equipement=' . 3;
                  }
            ...
            ?>
            <li class="modal-list">
               <img src="https://numerica.rahmeh.fr/img/etat/default_sol.jpg" alt="" class="img-list">
               <?php
               $url = '../scripts/edit_fondation.php?id=' . 
                     $_GET['id'] . '&link=' . $_GET['link'] . '&id_type_equipement=' . 3;
               ?>
               <form action="<?php echo($url); ?>" method="POST" enctype="multipart/form-data">
                  <div>
